...
export default function SeasonCard({ season, onClick }: Props) {
   return (
      <article
         onClick={onClick}
         className="flex gap-5 rounded-xl h-40 lg:h-52 overflow-hidden cursor-pointer hover:bg-secondary-light dark:hover:bg-secondary-dark hover:shadow-xl"
      >
         <motion.div
         ...
         <div className="w-full h-full overflow-y-auto main-scrollbar text-sm">
            <div className="text-base font-oswald font-semibold text-light-1 dark:text-dark1">
               {season.name}
            </div>
