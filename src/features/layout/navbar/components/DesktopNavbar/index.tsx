      ...
      <div className="w-full z-20 absolute top-2 h-12 flex justify-center pointer-events-auto">
         ...
         <div className="flex flex-1 justify-between">
            ...
            <div className="flex gap-4">
               ...
               <div className="flex mr-16 rounded-md border border-border-light dark:border-border-dark bg-primary-light dark:bg-primary-dark items-center h-full px-2 text-black dark:text-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black">
