...
export default function Reel({ spin }: Props) {
   return (
      <div
         className={`border-4 border-[#40382E] rounded-full bg-[#D0B07C] aspect-square h-full w-full flex items-center justify-center ${
            spin ? "animate-spin" : ""
         }`}
      >
         <div className="w-[90%] aspect-square grid grid-rows-3">
