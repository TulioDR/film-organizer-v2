...
export default function LoadingBoard({}: Props) {
   return (
      <div className="h-screen w-full fixed top-0 left-0 z-[200]">
         <div className="absolute right-4 bottom-4 flex items-center justify-center">
            <div className="w-72 rounded-md aspect-square bg-white dark:bg-black shadow-md border border-border-light dark:border-border-dark overflow-hidden">
               <div className="w-full h-full flex flex-col gap-2 items-center justify-center translate-y-[5%]">
                  ...
                  <div className="h-12 w-[70%] bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark flex items-center justify-center">
