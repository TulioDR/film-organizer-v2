...
import Front from "@/features/media-card/components/Front";
import Back from "@/features/media-card/components/Back";
import TransitionPosterModel from "@/features/media-card/models/TransitionPosterModel";
