...
export default function BackInfo({
   ...
   return (
      <div className="w-full flex-1 flex flex-col overflow-hidden pb-4">
         <div className="flex justify-between gap-2 text-text-2">
            <div className="flex-1">
               <h4 className="leading-5 font-semibold text-text-1 text-base uppercase">
                  {title}
               </h4>
         ...
         <div className="flex-1 relative overflow-hidden text-sm leading-tight text-text-2 mt-1">
            <p>{overview}</p>
